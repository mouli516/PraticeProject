...
public class TC_042_CreateNewOrganization_Industry_DDCheckTest {
	
	public WebDriver driver;
	@Test
	public void CreateNewOrganization_Industry_DDCheck() throws Throwable
	{
		...
		if(IndustryDropDown.isEnabled())
		{
			...
			Reporter.log("industry Dropdown is Enabled",true);
		}
		List<WebElement> IndustryDDoptions = select.getOptions();
		for(int i=0;i<=IndustryDDoptions.size()-1;i++)
		{
			System.out.println(IndustryDDoptions.get(i).getText());
		}
