...
public class TC_080_OrganizationPage_SearchBar_TerminatingTest {
	
	public WebDriver driver;
	@Test
	public void TC_080_OrganizationPage_SearchBar_Terminating() throws Throwable
	{
		...
		//Step:4 Click on close Symbol of search bar
		driver.findElement(By.xpath("//td[text()='[x]']")).click();
	}
